            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="login_info">
                        ...
                        <p class="f_p f_400 f_size_15">Create your own account here! </p>
                        <form action="" method="post"  class="login-form mt_60 general-form">
                            @csrf
                            <div class="form-group text_box">
                                <label class="f_p text_c f_400">Full Name</label>
                                <input name="val[name]" type="text" placeholder="Your full name">
                            </div>
                            <div class="form-group text_box">
                            ...
                            <button type="submit" class="btn_three">Sign Up</button>
                            <div class="alter-login text-center mt_30">
                                Already have account? <a class="login-link" href="{{url('login')}}">Sign In</a>
                            </div>
                        </form>
                    </div>
                </div>
